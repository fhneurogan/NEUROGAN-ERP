...
## What Carrie needs to sign off on before Phase 1 starts

Carrie Treat (QC / PCQI) needs to review and sign the Platform Validation Package — a document that confirms the foundation (Phase 0) works correctly and meets FDA requirements. That sign-off is the formal gate before any Phase 1 module begins.
